...
// type PetDescriptionCardProps = TouchableOpacityProps & {
//   petName: string;
//   address: string;
//   cep: string;
//   number: string;
...
// export function PetDescriptionCard({ petName, address, cep, number, phone, description, ...rest }: PetDescriptionCardProps) {
...
//         <VStack ml={2} flex={1}>
//           <Text fontSize="lg" mt={2}>{petName}</Text>
